...
if(isset($_POST['submit'])){
    ...
    if($conn->query($sql) === TRUE){
        echo "Thành công" . "<br>";
        echo "<a href='../showdulieu/display-monhoc.php' class='btn btn-success'>Quay lại</a>";
    }else{
...
?>
    ...
    <form action="" method="POST">
        <div class="input-group">
            <input type="text" name="masv" class="form-control" id="nameTag" value="<?php echo htmlspecialchars($_GET['mamh']); ?>" disabled>
